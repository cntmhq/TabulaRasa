...
Engram is a 100% client-side privacy actuator designed to streamline and automate GDPR/RODO Article 17 "Right to Erasure" requests targeting data brokers. 
...
Engram provides a standardized framework to assert your right to be forgotten effortlessly.
